...
let coxinhasConsumidas = parseInt(line[0]);
let nTotalParticipantes = parseInt(line[1]);

let qtdMediaCoxinhas = (coxinhasConsumidas / nTotalParticipantes).toFixed(2);

console.log(" " + qtdMediaCoxinhas);
